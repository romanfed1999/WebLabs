        ...
        if (window.navigator.onLine) {
            ...
            if (useLocalStorage) {
                ...
                idb.init({
                    ...
                    idb.insert("NewsTable", newsObj.getNewsData());
                    idb.insert("NewsTable", newsObj);
                });
            }
        }
...
class News {
    ...
    getNewsData() {
        console.log(`<div class=\"col-lg-3 col-md-3 col-sm-6 col-xs-12\"> <div class = \"thumbnail\"> <img src = \"637298374-612x612.jpg\" alt=\"Generic placeholder thumbnail\"> </div><div class = \"caption\"> <h3>${this.title}</h3><p>${this.body}</p><a href = \"#\" class=\"btn btn-default\" role=\"button\">Read</a></div> </div>`);
        return `<div class=\"col-lg-3 col-md-3 col-sm-6 col-xs-12\"> <div class = \"thumbnail\"> <img src = \"637298374-612x612.jpg\" alt=\"Generic placeholder thumbnail\"> </div><div class = \"caption\"> <h3>${this.title}</h3><p>${this.body}</p><a href = \"#\" class=\"btn btn-default\" role=\"button\">Read</a></div> </div>`;
    }
